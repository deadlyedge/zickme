class Webcam {
    constructor(webcamElement, facingMode = 'enviroment', canvasElement = null, snapSoundElement = null) {
      ...
      this._webcamElement.maxWidth = this._webcamElement.width || 300;  //640
      this._webcamElement.maxHeight = this._webcamElement.height || 300;  //this._webcamElement.width * (3 / 4);
...
//        }
        ...
        let data = this._canvasElement.toDataURL('image/jpg');
        return data;
      }
      else{
